...
import com.mobiusbobs.videoprocessing.core.gles.EglCore;
...
import com.mobiusbobs.videoprocessing.core.gles.WindowSurface;
...
public class TextureMovieEncoder implements Runnable {
    ...
    private static final int MSG_PAUSE_RECORDING = 12;
    ...
    public static class EncoderConfig {
        ...
        public EncoderConfig(int width, int height, int bitRate, EGLContext sharedEglContext) {
            mWidth = width;
            mHeight = height;
            mBitRate = bitRate;
    ...
    private void prepareEncoder(EGLContext sharedContext, int width, int height, int bitRate) {
        try {
            mVideoEncoder = new VideoEncoderCore(width, height, bitRate, muxerWrapper);
