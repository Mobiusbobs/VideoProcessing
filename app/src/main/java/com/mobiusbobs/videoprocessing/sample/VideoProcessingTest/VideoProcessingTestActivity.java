...
import com.mobiusbobs.videoprocessing.sample.VideoProcessingTest.videoProcessing.TopRightTextDrawer;
...
public class VideoProcessingTestActivity extends AppCompatActivity {
    ...
    private void runPrintMediaCondecInfo(String filePath) {
        ...
        MediaCodecChecker.checkVideoCapability(videoCodecInfo, videoFormat);
    }
